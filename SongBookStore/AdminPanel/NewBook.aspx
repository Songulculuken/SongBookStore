<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="NewBook.aspx.cs" Inherits="SongBookStore.AdminPanel.NewBook" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <body style="background-color:#f8f9fa">
    <h4 style="margin-left:20px">Yeni Kitap Ekleme Sayfasi</h4>
    <br />
