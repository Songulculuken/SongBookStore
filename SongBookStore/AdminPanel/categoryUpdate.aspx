<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="categoryUpdate.aspx.cs" Inherits="SongBookStore.AdminPanel.categoryUpdate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <body style="background-color:#f8f9fa">
    <h4 style="margin-left:20px">Kategori Guncelleme Sayfasi</h4>
