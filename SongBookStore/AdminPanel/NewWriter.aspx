<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="NewWriter.aspx.cs" Inherits="SongBookStore.AdminPanel.NewWriter" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <body style="background-color:#f8f9fa">
    <h4 style="margin-left:20px">Yeni Yazar Ekleme Sayfasi</h4>
    <br />
...
<td> <asp:DropDownList ID="DropDownList2" runat="server"></asp:DropDownList></td>
         ...
         <tr>
<td><asp:Label ID="Label2" runat="server" Text="Yazar Aktif Mi?"></asp:Label></td>
<td>
